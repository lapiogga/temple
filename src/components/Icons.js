...
export function DharmaWheel({ size = 34 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" aria-hidden="true">
      <circle cx="24" cy="24" r="19" stroke="var(--brand)" strokeWidth="1.7" />
      <circle cx="24" cy="24" r="15.5" stroke="var(--brand)" strokeWidth="1.1" />
      <circle cx="24" cy="24" r="4.4" stroke="var(--brand)" strokeWidth="1.7" />
      <circle cx="24" cy="24" r="1.7" fill="var(--brand)" />
...
export function LotusMark({ size = 440, className = "", opacity }) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 120 120" fill="var(--brand)"
...
export function MountainRidge({ className = "" }) {
  return (
    <svg className={className} viewBox="0 0 1200 150" preserveAspectRatio="xMidYMax slice" aria-hidden="true">
      <g stroke="var(--sec)" strokeWidth="2" fill="none" opacity=".55">
      ...
      <g fill="var(--brand)" opacity=".28"><path d="M748 104 l-8 -12 h16Z" /><rect x="742" y="104" width="12" height="10" /></g>
      <path d="M700 106 q48 -36 96 0" stroke="var(--brand)" strokeWidth="1.6" fill="none" opacity=".3" />
    </svg>
  );
}
    ...
    <svg width="0" height="0" style={{ position: "absolute" }} aria-hidden="true">
      <defs>
        <pattern id="dc" width="40" height="26" patternUnits="userSpaceOnUse">
          <path d="M2 24 A18 18 0 0 1 38 24Z" fill="var(--brand)" />
          <path d="M8 24 A12 12 0 0 1 32 24Z" fill="var(--gold-80)" />
          <path d="M14 24 A6 6 0 0 1 26 24Z" fill="var(--sec)" />
        </pattern>
      </defs>
    </svg>
  );
...
export function LotusPlaceholder({ size = 56 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="var(--brand)" fillOpacity=".16" aria-hidden="true">
...
export function MoktakPlaceholder({ size = 56 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" stroke="var(--sec)"
      strokeWidth="1.4" aria-hidden="true">
      <circle cx="24" cy="25" r="12" fill="var(--sec)" fillOpacity=".1" />
